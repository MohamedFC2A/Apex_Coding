...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'app.workspace.projectType.fullstack': 'Fullstack',
    'app.workspace.projectType.fullstackHint': 'Frontend + backend APIs with structured project layout.',
    ...
    'app.prompt.projectMode.fullstack': 'Fullstack',
  ...
  ar: {
    ...
    'app.workspace.projectType.fullstack': 'فل ستاك',
    'app.workspace.projectType.fullstackHint': 'واجهة + خلفية API مع هيكل مشروع منظم.',
    ...
    'app.prompt.projectMode.fullstack': 'فل ستاك',
